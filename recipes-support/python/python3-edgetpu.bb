...
RDEPENDS:${PN} = "libedgetpu python3 python3-numpy python3-pillow"
RDEPENDS:${PN}-examples = "bash ${PN}"

inherit setuptools3

PACKAGES += "${PN}-examples"

do_install:append:x86_64() {
...
FILES:${PN}-examples = "${datadir}/edgetpu/examples/"
